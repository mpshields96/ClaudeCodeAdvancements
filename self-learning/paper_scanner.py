...
DOMAIN_QUERIES = {
    ...
    "prediction": [
        ...
        "event contract pricing implied probability estimation",
        "election prediction market forecasting accuracy",
        "prediction market maker liquidity provision",
        "sports betting market efficiency edge detection",
    ],
    "statistics": [
        ...
        "change point detection drift streaming",
...
def evaluate_paper(paper):
    ...
    domain_keywords = {
        ...
        "prediction": ["prediction market", "forecasting", "calibration",
                       ...
                       "event contract", "implied probability", "election prediction",
                       "market maker", "sports betting", "edge detection"],
        "statistics": ["bayesian", "time series", "anomaly detection",
                       "sequential decision", "bandit", "probability calibration",
                       "kelly criterion", "position sizing", "change point",
                       "drift detection", "sharpe ratio", "risk-adjusted"],
