...
def get_known_tasks(current_session: int = 131) -> list[MasterTask]:
    ...
    return [
        ...
        MasterTask(
            ...
            last_touched_session=169, current_session=current_session,
            phases_completed=0, phases_total=2,
            aging_rate=0.5,
            next_action="Fix X-axis label overlap, integer axes, whitespace compression in chart_generator.py + Typst template.",
            tags=["visual", "reports", "design"],
        ),
        MasterTask(
            ...
            phases_completed=0, phases_total=6,
            aging_rate=1.0,
            next_action="Phase 1: Meta-learning dashboard — track self-learning system effectiveness over 20+ sessions.",
