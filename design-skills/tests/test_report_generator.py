...
class TestChartIntegration(unittest.TestCase):
    ...
    def test_chart_generator_produces_six_charts(self):
        ...
        expected = {"module_tests", "intelligence", "mt_status", "loc_distribution", "mt_progress", "frontier_status", "module_loc_treemap", "test_density_scatter", "module_composition", "coverage_ratio", "summary_figure"}
