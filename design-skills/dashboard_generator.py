...
class DashboardRenderer:
    ...
    def render(self, data: DashboardData, theme: str = "light") -> str:
        """Generate complete HTML string. theme: 'light' or 'dark'."""
...
<div class="container">
  <header>
    <div style="display:flex;justify-content:space-between;align-items:center">
      ...
      <button id="theme-toggle" onclick="toggleTheme()" title="Toggle dark/light mode" style="background:var(--surface);border:1px solid var(--border);border-radius:4px;padding:6px 12px;cursor:pointer;font-size:14px;color:var(--text-primary)">&#9789;</button>
    </div>
  </header>
...
{self._js()}
    ...
    def render_to_file(self, data: DashboardData, path: str, theme: str = "light"):
        """Render and write to file."""
        content = self.render(data, theme=theme)
        tmp = path + ".tmp"
...
<div class="module-search-wrapper">
  <input type="text" id="module-search" placeholder="Filter modules..." oninput="filterModules()">
</div>
<div class="modules">
{chr(10).join(cards)}
</div>
...
<thead><tr><th onclick="sortTable(0)" style="cursor:pointer">ID <span class="sort-indicator">&#9661;</span></th><th onclick="sortTable(1)" style="cursor:pointer">Name <span class="sort-indicator">&#9661;</span></th><th onclick="sortTable(2)" style="cursor:pointer">Priority <span class="sort-indicator">&#9661;</span></th><th onclick="sortTable(3)" style="cursor:pointer">Status <span class="sort-indicator">&#9661;</span></th></tr></thead>
<tbody>
{chr(10).join(rows)}
</tbody>
</table>
...
def cli_main(args: list = None):
    ...
    if cmd == "generate":
        ...
        renderer.render_to_file(data, output, theme=theme)
