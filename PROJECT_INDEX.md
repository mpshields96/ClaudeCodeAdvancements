...
| Design Skills | `design-skills/` | MT-17 Phase 5 + daily snapshots + trading_chart (MT-24) + 21 chart types + consistency audit + report_charts (wired into /cca-report) + BubbleChart + TreemapChart + SankeyChart + ScatterPlot + BoxPlot + HistogramChart + ViolinPlot + kalshi_data_collector (MT-33) | 1064 |
| Research | `research/` | Reddit scout, MT-8/MT-13 Phase 2 COMPLETE | 86 |

**Total: ~7850 tests (~198 suites). All must pass before any work.**
