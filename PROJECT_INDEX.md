...
**Total: ~9631 tests (~248 suites). All must pass before any work.**
...
- `research_roi_resolver.py` — MT-49 Phase 5: Research-to-production ROI tracking. Parses DELIVERY_ACK.md, fuzzy-matches to research_outcomes.jsonl, ROI by category/principle. CLI: resolve/report/summary. 24 tests (S173).
