...
| Design Skills | `design-skills/` | MT-17 Phase 5 + daily snapshots + trading_chart (MT-24) + 24 chart types (+ CandlestickChart + ForestPlot S191) + consistency audit + report_charts (wired into /cca-report, +4 statistical MT-32, +CalibrationPlot S190, +edge_forest +price_candles S191) + kalshi_data_collector (10 chart methods incl edge_forest + price_candles S191) + learning_data_collector + report_sidecar + report_differ (MT-33) + Dashboard v2 (dark mode, sortable, search, collapsible) + figure integration (slides/dashboard/website, MT-32 Phase 7) + chartjs_bridge (MT-52/E2, 6 Chart.js types incl scatter + horizontal_bar S191) | 1530 |
...
**Total: ~10,322 tests (~268 suites). All must pass before any work.**
